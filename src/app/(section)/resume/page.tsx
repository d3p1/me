    ...
    return (
        <div className="flex flex-col gap-6">
            <div className="flex flex-col items-center justify-center gap-6 text-center mb-8">
                ...
                <p>
                    Adobe Magento Certified Expert Developer with 13+ years of
                    hands-on experience designing, building, and optimizing
                    complex eCommerce platforms. Beyond eCommerce, I have a
                    strong passion for DevOps, graphics programming, and game
                    development.
                </p>
            </div>
